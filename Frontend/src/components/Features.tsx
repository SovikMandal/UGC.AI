    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Builds for modern brands and startups"
                    description="our AI integrations are designed to be allowing you to create unique and engaging content that resonates with your audience."
                />
