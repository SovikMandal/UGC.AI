...
export default function Hero() {
    ...
    const mainImageUrl = 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and a model photo - our AI instantly produce professional lifestile imagery and short-form videos optimized for commercial performance. Perfect for brands, creators, and agencies looking to scale content production and drive growth.
                            </motion.p>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">
                                            Use content for ads, social, and more
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
